...
func (impl userServiceImpl) Register(request *model.UserModel) (*model.UserModelResponse, error) {
...
func (impl userServiceImpl) Login(request *model.UserModel) (*model.UserModelResponse, error) {
	input := entity.UserEntity{
		Email:    request.Email,
